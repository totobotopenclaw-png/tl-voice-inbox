      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="space-y-4 sm:space-y-6 order-1">
            {/* Recording Card - Larger touch target on mobile, mt-auto for iPhone safe area */}
            <div className="bg-slate-900 rounded-xl p-6 sm:p-8 border border-slate-800 mt-4 sm:mt-0">
